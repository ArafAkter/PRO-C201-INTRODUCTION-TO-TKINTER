...
height_label=Label(window, text="Enter Your Height (cm)", fg = "black", bg = "lightcyan", font=("Calibri", 12))
height_label.place(x=20, y=140)

height_entry=Entry(window, text="", bd=2, width=15)
height_entry.place(x=150, y=142)

weight_label=Label(window, text="Enter Your Weight (Kg)", fg = "black", bg = "lightcyan", font=("Calibri", 12))
...
result_label=Label(result_frame,text=" ", bg = "green", font=("Calibri", 12), width=33)
